...
class ResBlock(nn.Module):
    def __init__(self, n_feats):
        super().__init__()
        self.conv1 = SobelConv2d(n_feats, n_feats, 3, padding=(3//2))
...
@register('drsensobel')
def make_drsensobel(n_resblocks=20, n_feats=64, upsampling=True, scale=2):
    args = Namespace()
