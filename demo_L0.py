...
if __name__ == '__main__':
    ...
    parser.add_argument('--lrdir', default=r'load/selfWHURS/sobel/low-sobel-test')
    parser.add_argument('--lsdir', default=r'load/selfWHURS/smooth/smooth-whurs-test-low-grad')
    parser.add_argument('--hrdir', default=r'load/selfWHURS/sobel/low-sobel-test')
